...
const GCSDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 space-y-4">
      <header className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">GCS Dashboard</h1>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4">
            <p className="font-bold">System State: BOOT (simulated)</p>
          </div>
          <div className="mt-4 flex space-x-2">
            <Button onClick={handleCalibrate}>Calibrate Sensors</Button>
          </div>
        </CardContent>
      </Card>

      {/* GRAPH STYLE VIEW (Telemetry Charts) */}
      <Card>
        <CardHeader>
        ...
        <CardContent className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              <YAxis yAxisId="left" label={{ value: "Altitude (m)", angle: -90, position: "insideLeft" }} domain={[0, 1100]} />
              <YAxis
                yAxisId="right"
                orientation="right"
              ...
              {/* You can add additional Lines (for humidity, etc.) as needed */}
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="h-96">
          <Canvas camera={{ position: [5, 5, 5] }}>
            ...
            <CanSat
              position={[
                relativeLocation.x / 1000, // apply scaling for display
      ...
      {/* 3D POSITION GRAPH (Relative to Launch Station) */}
      <Card>
        <CardHeader>
          <CardTitle>3D Position Graph</CardTitle>
        </CardHeader>
        <CardContent className="h-96">
          {/* Scale the relative position for display purposes */}
          <PositionGraph
            position={{
